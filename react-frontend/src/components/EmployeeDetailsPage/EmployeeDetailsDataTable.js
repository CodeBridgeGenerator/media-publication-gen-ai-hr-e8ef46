...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.jobRole}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.experience}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.skills}</p>
...
<Column field="jobRole" header="JobRole" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="experience" header="Experience" body={pTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="skills" header="Skills" body={pTemplate4} style={{ minWidth: "8rem" }} />
